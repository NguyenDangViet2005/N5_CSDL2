...
VALUES 
    ...
    ('CT11', N'Vinamilk', N'Giao dịch J', '0900000004', '0203940440', 'contactK@provider.com', 'PX10', N'10 Đường Dogenzaka');
...
VALUES 
    ('MH01', N'Smartphone', 'CT01', 'LH01', 100, N'Cái', 1500.00),
    ('MH02', N'Laptop', 'CT02', 'LH01', 50, N'Cái', 250000.00),
    ('MH03', N'Gạo', 'CT03', 'LH02', 200, N'Kg', 200.00),
    ('MH04', N'Nước mắm', 'CT04', 'LH02', 150, N'Lít', 300.00),
    ('MH05', N'Bát đĩa', 'CT05', 'LH03', 300, N'Set', 1500.00),
    ('MH06', N'Áo sơ mi', 'CT06', 'LH04', 120, N'Cái', 300.00),
    ('MH07', N'Sách giáo khoa', 'CT07', 'LH05', 500, N'Quyển', 500.00),
    ('MH08', N'Ghế sofa', 'CT08', 'LH06', 20, N'Cái', 80000.00),
    ('MH09', N'Paracetamol', 'CT09', 'LH07', 100, N'Hộp', 1500.00),
    ('MH10', N'Đồ chơi lắp ráp', 'CT10', 'LH08', 80, N'Cái', 2000.00),
...
VALUES 
    ...
    ('HD05', 'MH09', 150000, 6, 0.2),   
    ('HD05', 'MH10', 200000, 3, 0.15),
    ('HD06', 'MH11', 250000, 4, 0.3);
 
...
update nv
set nv.luongCB = 1.5*nv.luongCB
from NHANVIEN nv, DONDATHANG ddh, CHITIETDATHANG ctdh 
where nv.maNV = ddh.maNV and ddh.soHD = ctdh.soHD and ctdh.soLuong > 100 and YEAR(ddh.ngayGiaoHang) = 2022
...
where maNV NOT IN (
    select ddh.maNV from DONDATHANG  ddh  
